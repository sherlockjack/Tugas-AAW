...
const getTenantById = async (tenant_id) => {
    const result = await db_1.db
        ...
        .innerJoin(schemaTenantDetails.tenantDetails, (0, drizzle_orm_1.eq)(schemaTenant.tenants.id, schemaTenantDetails.tenantDetails.tenant_id))
